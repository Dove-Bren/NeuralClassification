...
These errors are likely due to bad encoding. Our group noticed that large
images with thin outlines lost information when being resized to a smaller 
image. Also most of our outlines were collected from the internet. These
outlines were incredibly diverse and perhaps the details of each image were
simply 'drowned' out in the diversity of the images. If we standardized our 
input we would have likely seen better results.
